...
public abstract class BaseRecyAdapter<T> extends RecyclerView.Adapter<BaseRecyViewHolder> {
    ...
    public BaseRecyAdapter(Context context, List<T> list, int itemLayoutId) {
    ...
    public BaseRecyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return BaseRecyViewHolder.getRecyclerHolder(context, view);
    }
...
//            holder.itemView.setBackgroundResource(R.drawable.recycler_bg);//设置背景
     ...
     */
    public abstract void convert(BaseRecyViewHolder holder, T item, int position, boolean isScrolling);
}
